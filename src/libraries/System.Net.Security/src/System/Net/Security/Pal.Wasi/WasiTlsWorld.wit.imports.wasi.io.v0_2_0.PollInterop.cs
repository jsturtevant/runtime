...
namespace WasiTlsWorld.wit.imports.wasi.io.v0_2_0
{
    internal static class PollInterop {
        ...
        internal  static unsafe uint[] Poll(List<global::WasiTlsWorld.wit.imports.wasi.io.v0_2_0.IPoll.Pollable> @in)
        {
            ...
            for (int index = 0; index < @in.Count; ++index) {
                global::WasiTlsWorld.wit.imports.wasi.io.v0_2_0.IPoll.Pollable element = @in[index];
