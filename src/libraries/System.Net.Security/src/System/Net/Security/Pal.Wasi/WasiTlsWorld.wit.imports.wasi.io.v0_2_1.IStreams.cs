...
namespace WasiTlsWorld.wit.imports.wasi.io.v0_2_1;
...
internal interface IStreams {
    ...
    */
    ...
    internal class StreamError {
        ...
        internal static StreamError lastOperationFailed(global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IError.Error lastOperationFailed) {
        ...
        internal global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IError.Error AsLastOperationFailed
        {
            get
            {
                if (Tag == LAST_OPERATION_FAILED)
                return (global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IError.Error)value!;
                else
    ...
    internal class InputStream: IDisposable {
        ...
        internal   unsafe byte[] Read(ulong len)
        {
            ...
            fixed (uint* retAreaByte0 = &retArea[0])
            {
                ...
                Result<byte[], global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted6;
                ...
                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {
                        ...
                        lifted6 = Result<byte[], global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.ok(array);
                        break;
                    }
                    case 1: {

                        global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError lifted;

                        switch (new Span<byte>((void*)(ptr + 4), 1)[0]) {
                            case 0: {
                                var resource = new global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IError.Error(new global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IError.Error.THandle(BitConverter.ToInt32(new Span<byte>((void*)(ptr + 8), 4))));

                                lifted = global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError.lastOperationFailed(resource);
                                break;
                            }
                            case 1: {

                                lifted = global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError.closed();
                                break;
                            }
                        ...
                        lifted6 = Result<byte[], global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.err(lifted);
                        break;
                    }
        ...
        internal   unsafe ulong Skip(ulong len)
        {
            ...
            fixed (ulong* retAreaByte0 = &retArea[0])
            {
                ...
                Result<ulong, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted6;

                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {

                        lifted6 = Result<ulong, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.ok(unchecked((ulong)(BitConverter.ToInt64(new Span<byte>((void*)(ptr + 8), 8)))));
                        break;
                    }
                    case 1: {
                        ...
                        switch (new Span<byte>((void*)(ptr + 8), 1)[0]) {
                            case 0: {
                                var resource = new global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IError.Error(new global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IError.Error.THandle(BitConverter.ToInt32(new Span<byte>((void*)(ptr + 12), 4))));
                        ...
                        lifted6 = Result<ulong, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.err(lifted);
                        break;
                    }
    ...
    internal class OutputStream: IDisposable {
        ...
        internal   unsafe void Write(byte[] contents)
        {
            ...
            fixed (uint* retAreaByte0 = &retArea[0])
            {
                ...
                Result<None, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted6;

                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {

                        lifted6 = Result<None, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.ok(new global::WasiTlsWorld.None());
                        break;
                    }
                    case 1: {
                        ...
                        lifted6 = Result<None, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.err(lifted);
                        break;
                    }
        ...
        internal   unsafe ulong Splice(global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.InputStream src, ulong len)
        {
            var handle = this.Handle;
            ...
            fixed (ulong* retAreaByte0 = &retArea[0])
            {
                ...
                Result<ulong, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted7;

                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {

                        lifted7 = Result<ulong, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.ok(unchecked((ulong)(BitConverter.ToInt64(new Span<byte>((void*)(ptr + 8), 8)))));
                        break;
                    }
                    case 1: {
                        ...
                        lifted7 = Result<ulong, global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.err(lifted);
                        break;
                    }
        ...
        internal   unsafe ulong BlockingSplice(global::WasiTlsWorld.wit.imports.wasi.io.v0_2_1.IStreams.InputStream src, ulong len)
        {
            var handle = this.Handle;
            var handle0 = src.Handle;
